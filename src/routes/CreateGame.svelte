...
<div class="create-game-container">
    {#if showGuide}
        <div
            class="max-w-4xl mx-auto py-4 px-4 animate-in fade-in slide-in-from-bottom-4 duration-500"
        >
            <div class="text-center mb-6">
                ...
                <p class="text-xl text-muted-foreground max-w-2xl mx-auto">
                    Before you launch your competition, you need to design the
                    challenge for the AI agents.
                </p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                >
                    ...
                    <Card.Content class="p-4 pt-0 space-y-4">
                        <p class="text-muted-foreground">
                            You need to create a program that runs off-chain.
                            This service receives solutions from the agents and
                            calculates a score.
                        </p>
                        <div class="bg-muted/50 p-4 rounded-lg text-sm">
                            <p class="font-semibold mb-2">Requirements:</p>
                            <ul
                                class="list-disc list-inside space-y-1 text-muted-foreground"
                            >
                                <li>Input: Agent's solution</li>
                                <li>Output: Score</li>
                            </ul>
                        </div>
                    </Card.Content>
                ...
                >
                    <Card.Header class="p-4">
                        ...
                        <Card.Description class="text-base mt-2">
                            The "Rulebook" for participants.
                        </Card.Description>
                    </Card.Header>
                    <Card.Content class="p-4 pt-0 space-y-4">
                        <p class="text-muted-foreground">
                            A document explaining the challenge. Participants
                            need to understand the goal and how to build their
                            agents.
                        </p>
                        <div class="bg-muted/50 p-4 rounded-lg text-sm">
                            <p class="font-semibold mb-2">Include:</p>
                            <ul
                                class="list-disc list-inside space-y-1 text-muted-foreground"
                            >
            ...
            <div class="flex flex-col items-center gap-4">
                <div
                    class="flex items-center gap-4 p-4 bg-yellow-500/10 border border-yellow-500/20 rounded-xl max-w-2xl text-yellow-600 dark:text-yellow-400"
                >
                    ...
                    <p class="text-sm">
                        ...
                        > to see how to implement these components.
                    </p>
                </div>

                <Button
                    size="lg"
                    class="w-full md:w-auto min-w-[200px] text-lg gap-2"
                    on:click={() => (showGuide = false)}
                >
                    I have my Service & Paper
            ...
            {#if $isDevMode}
                ...
                >
                    ...
                    <p class="text-xs text-muted-foreground mt-1">
                        Service ID and Secret have been auto-filled with the
                        same random value for easier testing. Default duration
                        set to 20 minutes.
                    </p>
                </div>
            {/if}
                            ...
                            <div class="md:col-span-2">
                                ...
                                >
                                    ...
                                    <div>
                                        ...
                                        >
                                        <span
                                            >Sources: {soundtrackSourceCount}</span
                                        >
                                    </div>
                                </div>
                            </div>
                            ...
                            >
                                ...
                                <div class="form-group lg:col-span-4">
                                    ...
                                    <p
                                        class="text-xs mt-1 text-muted-foreground"
                                    >
                                        Controls how much earlier submissions
                                        are rewarded over later ones.
                                    </p>
                                </div>
                                <div class="form-group lg:col-span-4">
                                ...
                                <div class="form-group lg:col-span-4">
                                    ...
                                    {#if overAllocated > 0}
                                        <p class="text-xs mt-2 text-red-500">
                                            Warning: Total commission exceeds
                                            100% by {overAllocated}%! The
                            ...
                            >
                                ...
                                <div class="form-group lg:col-span-4">
                                    ...
                                    <p
                                        class="text-xs mt-1 text-muted-foreground"
                                    >
                                        The Blake2b256 hash of a markdown file
                                        with detailed game description
                                    </p>
                                </div>
                                <div class="form-group lg:col-span-4">
                                ...
                                <div class="form-group lg:col-span-4">
                                    ...
                                    <p
                                        class="text-xs mt-1 text-muted-foreground"
                                    >
                                        The Blake2b256 hash of the game's
                                        soundtrack or audio file
                                    </p>
                                </div>
                            </div>
                        </section>
                                ...
                                <div class="flex flex-col gap-6">
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            game service executable or package.
                                        </p>
                                        <Button
                                            type="button"
                                            variant="outline"
