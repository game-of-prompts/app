...
export interface GameConstants {
    ...
    CREATOR_OMISSION_NO_PENALTY_PERIOD: number;  // VARIOS BLOQUES PARA NO PERMITIR QUE SE MODFIQUE EL RESOLVER
    MAX_SCORE_LIST: number;
    DEV_COMMISSION_PERCENTAGE: number;
    STAKE_DENOMINATOR: number;
    COOLDOWN_IN_BLOCKS: number;
    PARTICIPATION_ABANDONED_FUNDS_GRACE_PERIOD: number;   // A PARTIR DE RESOLUTION DEADLINE (R8.5)
...
const DevelopmentMode: GameConstants = {
    ...
    PARTICIPATION_ABANDONED_FUNDS_GRACE_PERIOD: 5,
...
const ProductionMode: GameConstants = {
    ...
    STAKE_DENOMINATOR: 5,
    COOLDOWN_IN_BLOCKS: 30,
    PARTICIPATION_ABANDONED_FUNDS_GRACE_PERIOD: 64800,  // aprox. 90 days
