...
import { type Judge, type TypeNFT } from '$lib/ergo/reputation/objects';
...
export const judge_detail = writable<Judge|null>(null);
...
export const reputation_proof = writable<Judge|null>(null);
export const judges = writable<{data: Map<string, Judge>; last_fetch: number}>({
    data: new Map(),
    last_fetch: 0
})