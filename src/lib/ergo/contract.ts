...
import GOP_GAME_BOX_SCRIPT_SOURCE from '../../../contracts/game_active.es?raw';
import GOP_PARTICIPATION_BOX_SCRIPT_SOURCE from '../../../contracts/participation_submited.es?raw';
