...
const COOLDOWN_IN_BLOCKS = 3500; // This value must be higher than the contract's cooldown period to ensure it is valid. Can be any value greater than 3000, as per the contract's logic. 
